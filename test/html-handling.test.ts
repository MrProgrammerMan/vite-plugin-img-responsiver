...
it("processes HTML and replaces img tags with picture tags", async () => {
  ...
  const pathToHash = path.normalize(path.join(htmlDir, "images", "test-image.jpg"));
  ...
  const expectedPictureTag =
    "<picture>" +
    '<source type="image/webp" srcset="..\\images/1478709796-240.webp 240w,..\\images/1478709796-480.webp 480w,..\\images/1478709796-768.webp 768w">' +
    '<source type="image/avif" srcset="..\\images/1478709796-240.avif 240w,..\\images/1478709796-480.avif 480w,..\\images/1478709796-768.avif 768w">' +
    '<source type="image/jpg" srcset="..\\images/1478709796-240.jpg 240w,..\\images/1478709796-480.jpg 480w,..\\images/1478709796-768.jpg 768w">' +
